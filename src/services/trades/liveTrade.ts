// ==================================================
// SMC Trading Journal — Live Trade Service
// ==================================================

import { createUserClient } from '../../config/database';
import { NotFoundError } from '../../middleware/errorHandler';
import { LiveTradeRow, TradeFilterParams } from '../../types';

export class LiveTradeService {
  /**
   * Create a new live trade
   */
  static async createTrade(accessToken: string, userId: string, data: Partial<LiveTradeRow>) {
  ...
  /**
   * Get all live trades with filtering and pagination
   */
   ...
   * Update a live trade
   */
  static async updateTrade(accessToken: string, userId: string, tradeId: string, data: Partial<LiveTradeRow>) {
    const supabase = createUserClient(accessToken);
    const { data: trade, error } = await supabase
      .from('live_trades')
      .update(data)
